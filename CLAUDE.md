...
## Tab structure (v2.12.96)
```
CONSOLE(1) WF ART(2) SSTV(3) SCHEDULE(4) LOG(5)
CONFIG(6) SYSTEM(7) API CFG(8) AI(9)  ACID TRIP(!)  CLIPS(0)  SPEC OPS(#)  SENTIENT(@)
```
- Pane IDs: `pane-dash`, `pane-wfall`, `pane-sstv`,
  `pane-sched`, `pane-hist`, `pane-cfg`, `pane-system`, `pane-apicfg`,
  `pane-ai`, `pane-trip`, `pane-clips`, `pane-specops`, `pane-sentient`
...
- BEACON was merged into SCHEDULE (50/50 split) in v2.12.96
